...
#include <client_server_actionlib_cpp/FibonacciAction.h>
#include <ros/ros.h>

class FibonacciAction {
 protected:
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<client_server_actionlib_cpp::FibonacciAction>
      as_;  // NodeHandle instance must be created before this line. Otherwise
            // strange error occurs.
  std::string action_name_;
  // create messages that are used to published feedback/result
  client_server_actionlib_cpp::FibonacciFeedback feedback_;
  client_server_actionlib_cpp::FibonacciResult result_;
 ...
 public:
  ...
  void executeCB(const client_server_actionlib_cpp::FibonacciGoalConstPtr& goal) {
    // helper variables
    ros::Rate r(1);
    bool success = true;
