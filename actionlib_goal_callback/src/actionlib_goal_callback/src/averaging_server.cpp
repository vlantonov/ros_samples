...
#include <actionlib_goal_callback/AveragingAction.h>
#include <ros/ros.h>
...
class AveragingAction {
 ...
 protected:
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<actionlib_goal_callback::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  actionlib_goal_callback::AveragingFeedback feedback_;
  actionlib_goal_callback::AveragingResult result_;
  ros::Subscriber sub_;
};
